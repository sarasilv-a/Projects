...
def banner():
    print("=" * 70)
    print("DEMO: FULL SYSTEM DEBUG (same as full, longer, no hard exit)")
    print("=" * 70)
    print()
...
async def main():
    ...
    hospitals, ambulances, helicopters, doctors = [], [], [], []
    RUN_SECONDS = 120
    ...
    try:
        ...
        patient = PatientAgent(pat_acc.jid, pat_acc.password, patient_id="P001", name="Alice")
        await patient.start()
