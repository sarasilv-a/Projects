  ...
  try {
    ...
    if (session.isStudent) {
      ...
      data = {
        ...
        age: '—',
        location: '—',
        profession: 'Diretor de curso',
        education: '—',
        frequency: '—',
        interests: '—',
        objectives: 'Gerir o curso com eficiência.',
        challenges: 'Gerir alunos e horários.',
        solutions: 'Aplicações de gestão e boa comunicação.',
        quote: '"A nossa missão é servir os estudantes com qualidade."'
      }
    }
