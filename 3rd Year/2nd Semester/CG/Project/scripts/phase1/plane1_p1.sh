...
# Gerar o modelo
echo "Gerando modelo..."
cd "$BUILD_DIR" && ./generator plane 4 6 plane_4_6.3d && cd -

# Verificar se modelo foi gerado
if [[ ! -f "$MODELS/plane_4_6.3d" ]]; then
...
cd "$BUILD_DIR" && ./engine "../$SCENES/ours_tests/test_1_plane1.xml"