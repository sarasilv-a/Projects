...
# Gerar o modelo
echo "Gerando modelo..."
cd "$BUILD_DIR" && ./generator cone 1 2 4 3 cone_1_2_4_3.3d && cd -

# Verificar se o modelo foi gerado
if [[ ! -f "$MODELS/cone_1_2_4_3.3d" ]]; then
...
cd "$BUILD_DIR" && ./engine "../$SCENES/tests/test_files_phase_1/test_1_2.xml"