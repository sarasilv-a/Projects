...
class Node:
    def __init__(self, name, id=-1, priority=0, accessibility=None, delivery_deadline=None, SuplementosNecessarios=0,heuristica=0):
        self.m_id = id
        ...
        self.SuplementosNecessarios = SuplementosNecessarios
        self.m_heuristica = heuristica  # Atributo para o valor heurístico do nó
    ...
    def getSuplementosNecessarios(self):
        return self.SuplementosNecessarios
    ...
    def setSuplementosnecessarios(self, suplementos):
        self.SuplementosNecessarios = suplementos
    ...
    def deliver_suplementos(self, quantidade):
        if self.SuplementosNecessarios > 0:
            entregues = min(quantidade, self.SuplementosNecessarios)
            self.SuplementosNecessarios -= entregues
            return entregues
        return 0
    ...
    def __str__(self):
        return (f"Node(name={self.m_name}, id={self.m_id}, priority={self.m_priority}, "
                ...
                f"weather={self.m_weather}, Suplementos necessários={self.SuplementosNecessarios})")
